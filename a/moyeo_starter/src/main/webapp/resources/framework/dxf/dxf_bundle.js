...
const Polygon = require('./Polygon'); // 추가 20200212
...
class Drawing
{
    ...
    drawPolygon(points)
    {
        this.activeLayer.addShape(new Polygon(points));
        return this;
    }
    /**
...
},{"./Arc":1,"./Circle":2,"./Face":3,"./Layer":4,"./Line":5,"./LineType":6,"./Point":7,"./Polyline":8,"./Polygon":88,"./Polyline3d":9,"./Text":10}]},{},[]);
